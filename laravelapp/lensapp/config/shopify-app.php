...
return [
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES','read_products,write_products,read_script_tags,write_script_tags,read_themes,write_themes,read_orders,write_orders,read_all_orders,read_inventory,write_inventory,read_product_listings'),
   ...
   // ],
     ...
     'webhooks' => [
        [
            ...
            'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://prescription.installmultiplepixel.com/lensapp/webhook/app-uninstalled')
        ],
    ],
