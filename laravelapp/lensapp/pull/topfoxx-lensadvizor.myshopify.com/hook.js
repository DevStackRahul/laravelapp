...
document.head.appendChild(script);
 ...
 var o = void 0;
function change(e, o) {
  if (t('[data-step="'+ e +'"]').addClass("active-step").removeClass("done-step"), t(".modal-prescription .header-prescription .prev-arrow").removeClass("d-none"), t(".modal-prescription #optical--footer #prev-button").removeClass("d-none"), t('[data-step="' + o + '"]').addClass("done-step"), t('[data-step="' + o + '"]').removeClass("active-step"), 3 == o) {
  ...
  3 == e && "0" == t(".pupillary-cyl").val() && "0.00" == t(".left-sph").val() && "0.00" == t(".right-sph").val() && "0.00" == t(".right-cyl").val() && "000" == t(".right-axis").val() && "0.00" == t(".left-cyl").val() && "000" == t(".left-axis").val() && "0" == t(".pupillary-sph").val() && 0 == t("#customCheck2").prop("checked") && "0" == t(".pupillary-sph").val() && t("#optical--footer .next-button #next-button").prop("disabled", !0), 5 == e && (0 == t("#rx-material1").is(":checked") ? t(".sucessfuly-msg").addClass("d-none") : t(".sucessfuly-msg").removeClass("d-none"), setTimeout((function() {
...
t("body").on("change", 'input[type="file"]', function(o) {
  if (o.preventDefault(), "" != t(this).val()) {
    ...
    i.append("attachment", n), t.ajax({
      url: "http://prescription.pulseinfosys.in/upload_api/prescription",
      method: "POST",
      contentType: !1,
      cache: !1,
      processData: !1,
...
t("body").on("click", ".content-prescription .select-prescription .select-options label", function() {
  ...
  setTimeout((function() {
    if ("radio" == e.closest(".select-options").find("input").attr("type") && !0 === e.closest(".select-options").find("input").prop("checked"))
      if ("single-vision-clear-without-blue-light" == (o = e.closest(".select-options").find("input").attr("data-lens")) ? t(".warning-msg").removeClass("d-none") : t(".warning-msg").addClass("d-none"), "non-prescription" == o) {
        ...
        5 == c ? (t("#optical--footer .next-button").addClass("d-none"), t("#optical--footer .rx-add-to-cart").removeClass("d-none")) : 4 == c ? t("#optical--footer .next-button #next-button").prop("disabled", !0) : (t("#optical--footer .next-button").removeClass("d-none"), t("#optical--footer .rx-add-to-cart").addClass("d-none")), "reading" == o && "2" == c && c++
      }
  }), 100)
}),
  ...
  setTimeout((function() {
    if ("radio" == o.closest(".select-options").find("input").attr("type")) {
      ...
      if (!0 === n && "Upload" != i) {
        ...
        5 == s ? (t("#optical--footer .next-button").addClass("d-none"), t("#optical--footer .rx-add-to-cart").removeClass("d-none")) : 4 == s ? t("#optical--footer .next-button #next-button").prop("disabled", !0) : (t("#optical--footer .next-button").removeClass("d-none"), t("#optical--footer .rx-add-to-cart").addClass("d-none")), e(s, r)
      }
  ...
  setTimeout((function() {
    if ("radio" == o.closest(".select-options").find("input").attr("type") && !0 === o.closest(".select-options").find("input").prop("checked")) {
      ...
      4 == a ? (t("#optical--footer .next-button").addClass("d-none"), t("#optical--footer .rx-add-to-cart").removeClass("d-none")) : 3 == a || (t("#optical--footer .next-button").removeClass("d-none"), t("#optical--footer .rx-add-to-cart").addClass("d-none")), e(a, i)
    }
  }), 100)
}),   
  ...
  if (t(this).closest(".modal-prescription").find(".content-prescription").find(".step-wrapper").hasClass("active-step")) {
    ...
    if ("single-vision-with-clear-anti-blue-light-blocking-technology" == o && 3 == n && (i = 5), console.log(i), 5 == i ? (t("#optical--footer .next-button").addClass("d-none"), t("#optical--footer .rx-add-to-cart").removeClass("d-none")) : 3 == i ? "0" == t(".pupillary-cyl").val() && "0.00" == t(".left-sph").val() && "0.00" == t(".right-sph").val() && "0.00" == t(".right-cyl").val() && "000" == t(".right-axis").val() && "0.00" == t(".left-cyl").val() && "000" == t(".left-axis").val() && "0" == t(".pupillary-sph").val() && 0 == t("#customCheck2").prop("checked") && t("#optical--footer .next-button #next-button").prop("disabled", !0) : (t("#optical--footer .next-button").removeClass("d-none"), t("#optical--footer .rx-add-to-cart").addClass("d-none")), "3" == n) {
      var a = "";
  ...
  if (e.closest(".modal-prescription").find(".content-prescription").find(".step-wrapper").hasClass("active-step")) {
    ...
    2 == n && e.addClass("d-none"), 5 == n && (t("#optical--footer .next-button").removeClass("d-none"), t("#optical--footer .rx-add-to-cart").addClass("d-none")), "single-vision-with-clear-anti-blue-light-blocking-technology" == o && 5 == n && i--,
      function(e, o) {
...
t(".prescription-qty").val(n), t("body").on("change", ".shopify-product-form .tt-input-counter input", function() {
  ...
  t.preventDefault(), e(5, 4)
}),
t("body").on("click", ".yes-please", function(o) {
  o.preventDefault(), t(".rx-material1").trigger("click"), t(".warning-msg").addClass("d-none"), t('[data-step="4"]').removeClass("done-step"), t("#optical--footer .next-button").addClass("d-none"), t("#optical--footer .rx-add-to-cart").removeClass("d-none"), e(5, 4)
}),
